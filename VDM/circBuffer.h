...
int audbuff_space(audbuff*ab){

    return CIRC_SPACE(ab->cb.head,ab->cb.tail,ab->capability);
}

int audbuff_size(audbuff*ab){

    return CIRC_CNT(ab->cb.head,ab->cb.tail,ab->capability);
}
